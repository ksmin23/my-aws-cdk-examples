 ...
 * (6) [Delta Lake(v1.0.0) documentation](https://docs.delta.io/1.0.0/index.html)
 * (7) [Delta Lake(v1.0.0) - Table deletes, updates, and merges](https://docs.delta.io/1.0.0/delta-update.html)
