...
class MskServerlessStack(Stack):
  ...
  def __init__(self, scope: Construct, construct_id: str, vpc, **kwargs) -> None:
    ...
    cdk.CfnOutput(self, f'{self.stack_name}-SecurityGroupId',
      value=self.sg_msk_client.security_group_id)
    cdk.CfnOutput(self, f'{self.stack_name}-ClusterName',
      value=self.msk_cluster_name)
    cdk.CfnOutput(self, f'{self.stack_name}-ClusterArn',
