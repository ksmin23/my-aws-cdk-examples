...
class MemoryDBStack(Stack):
  ...
  def __init__(self, scope: Construct, construct_id: str, vpc, **kwargs) -> None:
    ...
    memorydb_cluster = aws_memorydb.CfnCluster(self, 'MemoryDBCluster',
      ...
      engine=memorydb_cluster_props.get("engine", "Valkey"),
      engine_version=memorydb_cluster_props.get("engine_version", "7.3"),
      ...
      tags=[
        cdk.CfnTag(key='Name', value='memorydb-cluster-for-valkey'),
        cdk.CfnTag(key='desc', value='memorydb cluster for valkey')
      ],
      tls_enabled=True
    )
