...
ln -nsf msk_client.properties client.properties
chown -R ec2-user /home/ec2-user/msk_client.properties
...
'''
    ...
    commands += f'''
su -c "pip3 install mimesis==4.1.3 --user" -s /bin/sh ec2-user
