...
class ECSNlbFargateServiceStack(Stack):
  ...
  def __init__(self, scope: Construct, construct_id: str,
    ...
    **kwargs) -> None:
    ...
    service_name = self.node.try_get_context('ecs_service_name') or "streamlit-nlb-service"

    fargate_service = aws_ecs_patterns.NetworkLoadBalancedFargateService(self, "StreamlitDashboard",
