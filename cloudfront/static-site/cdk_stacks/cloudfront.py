...
class MyStaticSiteStack(Stack):
  ...
  def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
    ...
    cdk.CfnOutput(self, 'SiteBucket',
      value=site_bucket.bucket_name,
      export_name=f'{self.stack_name}-SiteBucket')
    ...
    cdk.CfnOutput(self, 'CloudFrontOriginAccessId',
      value=cloudfrontOAI.cloud_front_origin_access_identity_s3_canonical_user_id,
      export_name=f'{self.stack_name}-CloudFrontOAI')
